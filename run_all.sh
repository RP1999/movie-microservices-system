...
start_service "Movie Service (Shevin)"      movie-service      8002  "app.main:app"
start_service "Analytics Service (Dilina)"  analytics-service  8006  "main:app"
...
echo "Movie Service Swagger     : http://localhost:8002/docs"
echo "Analytics Service Swagger : http://localhost:8006/docs"
